...
public class IDCardUtil {
    ...
    public static Map<String, String> getInfo(String idNumber) {
        ...
        if (idNumber.length() == 15) {
            birthday =
                "19" + idNumber.substring(6, 8) + "-" + idNumber.substring(8, 10) + "-" + idNumber.substring(10, 12);
            gender =
            ...
            gender =
                Integer.parseInt(idNumber.substring(idNumber.length() - 4, idNumber.length() - 1)) % 2 == 0 ? "女" : "男";
